        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentConditions_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    VehicleDetails = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dispatches_Transporters_TransporterId",
            ...
            migrationBuilder.CreateTable(
                name: "OrderModificationRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderModificationRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderModificationRequests_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispatches_TransporterId",
                table: "Dispatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderModificationRequests_CompanyId",
                table: "OrderModificationRequests",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderModificationRequests_OrderId",
                table: "OrderModificationRequests",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderModificationRequests_RequestedByUserId",
                table: "OrderModificationRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentConditions_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transporters_CompanyId_Name",
                table: "Transporters",
                columns: new[] { "CompanyId", "Name" });
        }
